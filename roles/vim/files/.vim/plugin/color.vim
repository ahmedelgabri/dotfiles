...
augroup MyCustomColors
  ...
  autocmd ColorScheme * hi! clear SignColumn
        ...
        \| execute(printf('hi! OverLength guifg=%s ctermfg=%s guibg=%s ctermbg=%s', utils#get_color('WildMenu', 'fg', 'gui'), utils#get_color('WildMenu','fg', 'cterm'), utils#get_color('Normal', 'bg', 'gui'), utils#get_color('Normal','bg', 'cterm')))
