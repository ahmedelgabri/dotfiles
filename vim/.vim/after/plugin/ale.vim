...
au! OptionSet * let g:ale_javascript_prettier_options = '--config-precedence file-override --single-quote --no-editorconfig --print-width ' . &textwidth . ' --prose-wrap always --trailing-comma all --no-semi'
