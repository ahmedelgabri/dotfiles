# Generated by Powerlevel10k configuration wizard on 2024-06-08 at 21:26 CEST.
...
() {
 ...
 function prompt_my_jobs() {
  ...
  typeset -g POWERLEVEL9K_PROMPT_CHAR_OK_{VIINS,VICMD,VIVIS}_FOREGROUND=011
  ...
  typeset -g POWERLEVEL9K_VCS_DIRTY_ICON="%F{$red}*%F{$white}"
