# Generated by Powerlevel10k configuration wizard on 2024-10-21 at 17:07 CEST.
  ...
  function my_git_formatter() {
    ...
    if [[ -n $P9K_CONTENT ]]; then
      ...
      return
		...
		# Hex codes can be used like this %F{#ffffff}
		# https://github.com/romkatv/powerlevel10k/issues/130#issuecomment-2185728920
    if (( $1 )); then
      ...
      local muted='%242F'  # grey foreground
    else
      # Styling for incomplete and stale Git status.
      local       meta='%f'  # default foreground
      local      clean='%236F'  # grey foreground
    ...
    # [[ -z $VCS_STATUS_LOCAL_BRANCH && -z $VCS_STATUS_TAG ]] &&  # <-- this line
      res+="${muted} ${clean}${VCS_STATUS_COMMIT[1,8]}"

    # Show tracking branch name if it differs from local branch.
    if [[ -n ${VCS_STATUS_REMOTE_BRANCH:#$VCS_STATUS_LOCAL_BRANCH} ]]; then
      res+="${muted}:${clean}${(V)VCS_STATUS_REMOTE_BRANCH//\%/%%}"
    fi
    ...
    # ⇡42 if ahead of the push remote; no leading space if also behind the remote: ⇣42⇡42.
