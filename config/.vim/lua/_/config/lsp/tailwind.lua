    ...
    default_config = {
      ...
      root_dir = function(fname)
        return lsp.util.root_pattern("tailwind.config.js", "tailwind.config.ts")(
          ...
          lsp.util.root_pattern("postcss.config.js", "postcss.config.ts")(fname) or
          lsp.util.find_package_json_ancestor(fname) or
          lsp.util.find_node_modules_ancestor(fname) or
