# Shared configuration module for both NixOS and nix-darwin
# This module contains all common configuration that applies to any system
# managed by this flake, ensuring a single source of truth.
{
  self,
  config,
  pkgs,
